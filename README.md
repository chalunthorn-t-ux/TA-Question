...
ถ้าเป็น public ใครรู้ URL ก็เปิดอ่านได้ทั้งไฟล์

**โหมดนี้เลือกตอนสร้าง แก้ทีหลังไม่ได้** ถ้าเผลอสร้างเป็น public ต้องสร้าง store ใหม่
และต้องตั้ง `BLOB_ACCESS` ให้ตรงกับของจริง ไม่งั้นอัปโหลดจะถูกปฏิเสธ

`INDEX_BLOB_PREFIX` ยังควรตั้งอยู่ดี แต่หน้าที่หลักคือ**ให้สองฝั่งชี้ที่เดียวกัน**
ไม่ใช่การกันคนเดา — ความปลอดภัยมาจากโหมด private
